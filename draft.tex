...
%
Benefited from the novel framework of variation transformation,
...
On the other hand, the application of neural network guarantee the strong learning ability of our model.
...
Different from existing methods, we decide to shift our attention form single pixel classification to variation transformation.
%the pixel variation is now regarded as a whole to safeguard the data integrity.
More specifically, a FCN is employed to learn the patterns of pixel variations and mapping them into a new space where they are close to the groundtruth data.
...
The flow chart of proposed approach is illustrated in \reffig{flow_chart}. 
