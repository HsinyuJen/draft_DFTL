...
\todo{please improve the English of this paragraph}
...
%As shown in the \reffig{flow_chart}, 
After the transformation of observations of pixels,
pixel patches feed into the network are transformed into the probability patches,
