...
%
CDnet is the largest dataset for foreground detection as far as we are kown, containing 11 categories with several complex challenging scenes, such as Dynamic Background, Camera Jitter, Shadow, Night Videos, PTZ and so on. 
...
In contrast, the proposed approach performs better from others in this scene, since the essence of foreground detection is considered as a binary classification of pixels' observation over a time sequence. 
...
%
Transformation learning focused on learning a transformation from pixel variations to the probability of pixels belonging to foreground or background.
%
...
%
Comparisons with other traditional and deep learning methods shows that our DPVTL algorithms significantly improves performance on several challenging scenes.
