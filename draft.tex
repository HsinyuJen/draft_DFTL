...
%GMM 
% Ren:这里你说over time 不专业，但是论文里用得挺多的啊，表示随时间推移。还有那一句 pixels are .... to be if there exists ....， 我也是在其他论文里借过来用的。原文是Incoming pixels from video frames are labeled as background if there exists a Gaussian in the GMM, where the distance between its mean and the pixel lies within a certain bound. 
