...
\centering
    ...
    % 图例里描述一下。
    \caption{The demonstration of deep variation transformation. The pixels in the transformed variation become easier to be classified as foreground and background correctly.}
    \label{idea}
\end{figure}
