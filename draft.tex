...
\label{sec4}
In this section, the details of proposed approach is explained.
%
The flow chart of the proposed approach is illustrated in \reffig{flow_chart}.
%
We firstly introduce the procedure of generating pixels patch,
which is feed into the network as well as the description of pixel variation.
%
Then,
the architecture of the network, which is used for variation transformation, is explained.
%
...
the training frames are sampled from the whole frame sequenece uniformly.
%
...
After sampling the training frames,
...
%
Therefore,
there are labeling patches, which are captured by the similar procedure in the ground truth frames,
