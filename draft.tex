...
which is actually patches consist of pixels' observations.
%
...
Therefore,
our network entails learning a mapping from the input observations of pixels $x \in \mathcal{X}$ 
to the probability of the corresponding pixel belong to foreground or background.



As shown in the \reffig{flow_chart},
a end-to-end architecture network is proposed to transform the observations of pixels to a new space which is close to labels.
%
