...
% XXX 这句话还是有点问题
% 这句话我也没看懂。。。
Due to the global analyse of pixel variations and the strong learning ability of deep learning network,
the proposed approach adaptively learned a good transformation from pixel variation to labels and generates well performances in diverse natural scenes.
%    \textcolor{red}{
