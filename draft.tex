...
\begin{abstract}
%
% 你这里的说法不对啊，原来的方法关注的是像素值的分布，我们关注的是像素值的变动。这是我们之间的区别啊!
% 运动检测的已有方法主要关注于像素值的分布。
...
% cqzhao: 这句话有证据支持吗？先是他们没有抛弃时许相关性啊，然后抛弃后，为什么intermittent motion就会失败呢？不是要你回到我，是要你给我找到论文支持！一定要有论文支持才能写下判断的话！
