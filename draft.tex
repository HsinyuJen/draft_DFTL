...
In the DVTL model, 
the sequence of pixels' observations is used to represent the variation and input into the network for learning,
...
%
In particular,
we take advantage of the strong learning ability of FCN to learn an end-to-end representation of the pixel observation matrixes in a new space where the pixels can be easily classified to background and foreground.
%
